  ...
  async gestor(opts) {
    ...
    const pintar = async () => {
      ...
      cont.querySelectorAll('[data-del]').forEach(b =>
        b.onclick = async () => {
          const clave = prompt('Para eliminar este archivo ingrese la clave de administrador:');
          if (clave === null) return;
          if (clave !== 'LPS-ADMIN') { alert('Clave incorrecta. No se eliminó el archivo.'); return; }
          try {
